...
text.Text = "UR BANNED FROM RIVALS RETARD"
...
sub.Text = "THERES NO FUCKING ESCAPE"
...
warning.Text = "blud thought he got free rivals cheats ur banned in 12 hours bludtatochip!"
...
-- looping audio (needs an UPLOADED asset ID, not a local file)
local sound = Instance.new("Sound")
sound.SoundId = "rbxassetid://7266001792"  -- replace after uploading the mp3
sound.Volume = 3
sound.Looped = true
sound.Parent = gui
sound:Play()
